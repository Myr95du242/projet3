                    ...
                    <form action="index.php?action=checkContact" method="post" >
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" name="phone_number" value="<?php if(isset($_POST['phone_number']) AND !empty($_POST['phone_number'])){ echo $_POST['phone_number'] ;} ?>"  placeholder="Phone Number" id="phone_number" >
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Message</label>
                                <textarea rows="5" class="form-control" name="message" placeholder="Message" id="message" ></textarea><!-- required data-validation-required-message="Please enter a message."-->
